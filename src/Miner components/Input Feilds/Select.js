    ...
    const {theme} = useTheme()
        ...
        return (
            <>
                ...
                <select  onChange={onChange} value={value} className={`mt-4 px-4   ${bgimg && `selectImg`} relative outline-none py-2 w-full rounded-md  focus:outline-none cursor-pointer  ${SelectClassName}`}>
