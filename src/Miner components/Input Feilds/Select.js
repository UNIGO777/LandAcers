    ...
    const {theme} = useTheme()
        ...
        return (
            <div className='w-full'>
                ...
                <select  onChange={onChange} value={value} className={`mt-4 px-4   ${bgimg && `selectImg`} relative outline-none py-2 rounded-md  focus:outline-none cursor-pointer  ${SelectClassName}`}>
