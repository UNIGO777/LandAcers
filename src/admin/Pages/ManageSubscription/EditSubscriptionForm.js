...
function EditSubscriptionForm({ subscription, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex p-3 items-center justify-center z-50">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              {formData.features.map((feature, index) => (
                <div key={index} className="flex items-center space-x-2">
                  ...
                  <button
                    type="button"
                    className="px-3 py-2 border border-red-300 rounded-lg text-red-700 hover:bg-red-50"
          ...
          {subscription.pricing?.monthly && (
            <div className="grid grid-cols-2 gap-6">
              <div>
                <h4 className="font-medium text-gray-900 mb-4">Monthly Plan</h4>
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Properties Limit</label>
                    <input
                      type="text"
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Projects Limit</label>
                    <input
                      type="text"
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
              ...
              <div>
                <h4 className="font-medium text-gray-900 mb-4">Yearly Plan</h4>
                <div className="space-y-4">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Properties Limit</label>
                    <input
          ...
          {subscription?.payperpropertyprice && <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Pay Per Property (₹)</label>
            <input
              type="text"
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
