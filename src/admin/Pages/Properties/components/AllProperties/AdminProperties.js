...
const AdminProperties = () => {
  ...
  const getUniqueValues = (field) => {
    const values = new Set(PropertiesData.filter(property => property.ownerType === "Admin").map((property) => property.location[field]))
  ...
  return (
    <Layout>
      <div className="container px-4 py-8 mx-auto">
        <h1 className="mb-8 text-4xl font-bold text-gray-800">Admin Properties</h1>
